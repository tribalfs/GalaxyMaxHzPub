...
(1) Install [LADB Free](https://play.google.com/store/apps/details?id=com.draco.ladb.free&hl=en&gl=US)/[LADB Paid](https://play.google.com/store/apps/details?id=com.draco.ladb) from play store. Follow-up LADB setup instructions. Once LADB setup is done, execute `adb shell pm grant com.tribalfs.gmh android.permission.WRITE_SECURE_SETTINGS`
